defmodule Mastery.Core.Quiz do
  ...
  - Quiz.new/2 (%Quiz{})
    - Quiz.add_template/2
    - Quiz.select_question/1
  - Email (string)
  - Response.new/3 (%Response{})
  - Quiz.answer_question/2 (%Quiz{})
  - quiz.record
  """
  ...
  def add_template(quiz, fields) do
    ...
    templates =
      update_in(quiz.templates, [template.category], &add_to_template_list_or_nil(&1, template))

    %{quiz | templates: templates}
  end

  defp add_to_template_list_or_nil(nil, template), do: [template]
  defp add_to_template_list_or_nil(templates, template), do: [template | templates]
